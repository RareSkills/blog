...
![image shows the token ID divided into the collection id (`X` values) and item ID (`Y` values)](https://r2media.rareskills.io/ERC-1155-media/diagaram-256-bits-two-parts.png)
...
<video src="https://r2media.rareskills.io/ERC-1155-media/movie-bitshift-only.mp4" type="video/mp4" autoplay loop muted controls></video>
...
<video src="https://r2media.rareskills.io/ERC-1155-media/movie-bitshift-add.mp4" type="video/mp4" autoplay loop muted controls></video>
...
![Remix code sceenshot calling both functions](https://r2media.rareskills.io/ERC-1155-media/screenshot-remix-parse-id.png)
...
- **safeBatchTransferFrom**
    ...
    **SafeTransferFrom vs SafeBatchTransferFrom**
    ...
    ![Gas benchmark of SafeTransferFrom and SafeBatchTransferFrom](https://r2media.rareskills.io/ERC-1155-media/screenshot-gas-benchmark.png)
...
![Screenshot of common worlds nft on opensea](https://r2media.rareskills.io/ERC-1155-media/screenshot-opensea-common-worlds.png)
...
![Screenshot of one of common worlds collection](https://r2media.rareskills.io/ERC-1155-media/screenshot-opensea-watertank.png)
...
![Screenshot of a random Bored Ape Yacht Club NFT owned by F15C93](https://r2media.rareskills.io/ERC-1155-media/screenshot-opensea-bored-ape.png)
...
![Screenshot of common world metadata](https://r2media.rareskills.io/ERC-1155-media/screenshot-opensea-metadata.png)
...
![The game contract workflow diagram](https://r2media.rareskills.io/ERC-1155-media/game-workflow-diagram.png)

### ERC-1155 Token 0: Mint $IGC

![IGC token image](https://r2media.rareskills.io/ERC-1155-media/IGC.jpeg)
...
![Screenshot showing the transfer single event](https://r2media.rareskills.io/ERC-1155-media/screenshot-transfer-single-event.png)
...
![Screenshot of the player’s $IGC balance](https://r2media.rareskills.io/ERC-1155-media/screenshot-game-balance.png)

We see that our player now has a balance of `1500` $IGC (initial + reward).

### ERC-1155 Token 1: Minting Non-Fungible Assets (Cars)

![car nft](https://r2media.rareskills.io/ERC-1155-media/car.jpg)
...
![Screenshot of the log after the mintCar function is called](https://r2media.rareskills.io/ERC-1155-media/screenshot-log-from-to.png)
