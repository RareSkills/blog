...
The functions mint, deposit, redeem, and withdraw, have a second argument "receiver" for cases where the account receiving shares or assets from the ERC4626 is not `msg.sender`. This means I can deposit assets into the account and specify that the ERC4626 contract give you the shares.
