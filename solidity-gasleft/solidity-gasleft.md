...
(Note that it is not a good idea to push out Ether unless the addresses are trusted. A malicious receiver could submit an address of a smart contract that reverts when receiving Ether).
